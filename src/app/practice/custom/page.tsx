...
export default function CustomQuizBuilderPage() {
  ...
  const topicsByTrack: Record<string, { id: string; name: string }[]> = {
    ...
    unique: [
      { id: "unique", name: "All Unique Software Questions" },
      { id: "custom", name: "My User-Authored Questions" },
      { id: "mixtures-alligation", name: "Unique Multi-stage Mixtures" },
      { id: "matrix-deduction", name: "Unique DILR Matrix Grids" },
      { id: "flaw-in-reasoning", name: "Unique Critical Reasoning Flaws" },
    ],
  };
