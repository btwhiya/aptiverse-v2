...
export default function LearnIndexPage() {
  ...
  const tracks = [
    ...
    },
    {
      ...
      subTracks: [
        { name: "Tables & Caselets (Missing data, Caselets)", count: "40 Qs" },
        { name: "Graphs & Charts (Bar, Line, Pie, Radar)", count: "40 Qs" },
        { name: "Mixed Graphs & Calculation Basics", count: "80 Qs" },
        { name: "Arrangements, Puzzles & Tournaments", count: "120 Qs" },
        { name: "Scheduling, Venn Diagrams & Binary Logic", count: "120 Qs" },
      ],
    },
    {
      slug: "varc",
